...
def HandleImageQuery(request, index):
    """
    Fonction that return the ordered list of image based on the similarities with the request and the index.
    Request is a list of image features, index is an oject of index class
    """
    correspondances=index.corpus
    doc_list={} #dictionary
    request_seg=request #treatment of the request to create a list of word treated as the corpus (lemmatization, tokenization)
